  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-white">
      ...
      <div className="hidden lg:flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center bg-white px-10">
          <div className="max-w-lg">
            <h2 className="text-3xl font-semibold text-gray-900 mb-5">Prepare Your Photo</h2>
            ...
            <div className="mt-6">
              <Link href="/frames" className="bg-[#7C3F33] text-white px-10 py-3 rounded-full text-lg font-medium shadow-sm inline-block hover:bg-[#6A352B] transition-colors">
                Select Frame
              </Link>
            </div>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center bg-gray-50 px-10">
          <div className="w-full max-w-md">
            ...
            <div
              ...
              className="relative w-full bg-white border-2 border-dashed border-gray-300 rounded-lg overflow-hidden aspect-3/4 flex items-center justify-center cursor-pointer hover:border-[#7A3B33] transition-colors max-h-[65vh]"
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center text-[#7A3B33]">
                <div className="bg-[#7A3B33] rounded-full p-5 mb-4">
                ...
                <div className="text-lg font-medium">Tap to Upload Portrait Photo</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="lg:hidden flex-1 flex flex-col overflow-hidden px-5 py-4">
        <h2 className="text-xl font-semibold">Prepare Your Photo</h2>
        <p className="mt-2 text-sm text-gray-600">
          Upload a clear, high-resolution portrait photo. Make sure your face is well-lit and centered.
        </p>
        ...
        <div className="flex-1 mt-4 min-h-0">
          ...
          <div
            ...
            onClick={handleAreaClick}
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') handleAreaClick(); }}
            className="relative w-full h-full max-h-[55vh] bg-gray-100 border border-gray-200 rounded-sm overflow-hidden flex items-center justify-center cursor-pointer"
            aria-label="Upload portrait photo"
          >
            {preview ? (
              // preview image
            ...
            <div className="relative z-10 flex flex-col items-center text-center text-[#7A3B33]">
              <div className="bg-white/70 rounded-full p-4 mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 text-[#7A3B33]" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 5a3 3 0 100 6 3 3 0 000-6z" opacity="0.9" />
                  <path d="M19 7h-1.2l-.8-1.6A2 2 0 0014.4 4H9.6a2 2 0 00-1.6.4L7.2 7H6a2 2 0 00-2 2v8a2 2 0 002 2h13a2 2 0 002-2V9a2 2 0 00-2-2zM12 17a5 5 0 110-10 5 5 0 010 10z" />
                </svg>
              </div>
        ...
        <div className="mt-5 flex justify-center flex-shrink-0">
          <Link href="/frames" className="bg-[#7C3F33] text-white px-9 py-3 rounded-full text-base font-medium shadow-sm inline-block">
            Select Frame
          </Link>
        </div>
      </main>
